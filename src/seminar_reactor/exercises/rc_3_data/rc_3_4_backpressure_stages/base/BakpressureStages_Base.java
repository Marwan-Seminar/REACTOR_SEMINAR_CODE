package seminar_reactor.exercises.rc_3_data.rc_3_4_backpressure_stages.base;
 ...
 * 
 */
public class BakpressureStages_Base {
	
	public static void main(String[] args) {
		BakpressureStages_Base instance = new BakpressureStages_Base();
