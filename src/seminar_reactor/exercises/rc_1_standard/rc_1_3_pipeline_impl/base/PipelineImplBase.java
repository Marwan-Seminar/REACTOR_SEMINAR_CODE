package seminar_reactor.exercises.rc_1_standard.rc_1_3_pipeline_impl.base;
 ...
 * 	Uebung 1.3
 * 
 * Implementieren Sie die drei Interfaces aus der Klasse java.util.concurrent.Flow:
 * 
 * Publisher
 * Subscription
 * Subscriber
 ...
 * 
 * b) 	In der Methode MySipleSubscriber.onNext(Integer item) wird bei jedem Aufruf nur ein einziges Element ueber den Aufruf request(1) angefordert.
