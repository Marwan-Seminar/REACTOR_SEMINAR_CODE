package seminar_reactor.exercises.rc_2_api.rc_2_2_subscriber_api.solution;
...
b ) Programmiere einen einfachen Subscriber mithilfe der Klasse BaseSubscriber.
 ...
 c) Ein Advanced Subscriber, der Batches von Items anfordert 
...
public class SubscriberAPI_Solution {
	...
	private void a_lambdaSubscriber() {
		...
		source.subscribe( value-> {
			System.out.println("Simple Lambda Subscriber received: " + value);
		});
	}
